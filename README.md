...
There are two implementations, in the first one, the robot must clean the entirety of the room, in the second implementation the robot
gathers the requests at a given table and then delivers the request.

More information on the guide document
